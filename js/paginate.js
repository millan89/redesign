    ...
    function lignePaginate(){
        ...
        var pageButtons = function(numberOfPage,currentPage) {
            ...
            /** This (buttons) will create all the necessary buttons
              ...
              *
              * It also takes care of adding the "gotopage" and "pagecounter" button
             **/
            let buttons = "<input type='button' value='Prethodna' class='paginate_control_prev' onclick='paginate.sort("+(currentPage - 1)+")' "+prevDisabled+">";
            // let buttonNumberOfPage = "<input type='button' value='" + currentPage + ' - ' + numberOfPage + "' disabled>";
            // gore ako zelim broj 1 od 20
            ...
            let nextButton = "<input type='button' value='Sledeća' class='paginate_control_next' onclick='paginate.sort("+(currentPage + 1)+")' "+nextDisabled+">";
            buttons +=  nextButton;
        ...
        **/
        ...
        var launchPaginate = function(){
            ...
            // get the tag name of the first cell (in the first row)
            ...
            // contains first row if it has a (<th>) and nothing if (<td>)
        ...
        _lignePaginate.sort = function(selectedPageNumber) {
            /** create (rows) a variable to hold the row group
         ...
         *This is responsible for filtering the information according to a text box
          * also calls the method that hides the buttons part of the
          * pagination
         **/
