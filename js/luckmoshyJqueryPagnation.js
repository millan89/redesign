    ...
    LuckmoshyPagination.prototype = {
        ...
        buildListItems: function (pages) {
            ...
            if (this.options.next) {
                ...
                listItems.push('<li class="line-middle"><div></div></li>');
            }

            for (var i = 0; i < pages.numeric.length; i++) {
                listItems.push('<li class="strana">Strana&nbsp;</li>');
                listItems.push(this.buildItem('page', pages.numeric[i]));
                listItems.push('<li>&nbsp;od&nbsp;</li>');
            }
        ...
        buildItem: function (type, page) {
            ...
            if (type === 'last') {
                itemText = this.options.totalPages;
            }
            if (type === 'prev') {
                itemText = '<i class="fas fa-chevron-circle-left"></i>';
            }
            if (type === 'next') {
                itemText = '<i class="fas fa-chevron-circle-right"></i>';
            }
        ...
        render: function (pages) {
            ...
            console.log(this.$listContainer.children());
